...
class TaskExecution(AwsTaggedEntity, UuidModel):
    ...
    heartbeat_interval_seconds = models.PositiveIntegerField(null=True, blank=True)
    ...
    current_cpu_units = models.IntegerField(null=True, blank=True)
    mean_cpu_units = models.IntegerField(null=True, blank=True)
    max_cpu_units = models.IntegerField(null=True, blank=True)
    current_memory_mb = models.IntegerField(null=True, blank=True)
    mean_memory_mb = models.IntegerField(null=True, blank=True)
