...
""", [
    (SCHEDULE_TYPE_CRON, True,     1, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, 60,   True,  False),
    (SCHEDULE_TYPE_CRON, True,  None, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, 60,   True,  False),
    (SCHEDULE_TYPE_CRON, True,     1, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, 16,   False, True),
    (SCHEDULE_TYPE_CRON, False,    1, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, 60,   False, False),
    (SCHEDULE_TYPE_CRON, True,     2, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, 10,   True,  True),
    (SCHEDULE_TYPE_CRON, True,     3, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, 10,   True, True),
    (SCHEDULE_TYPE_CRON, True,     1, 0.9,   Event.Severity.ERROR, 2 * 24 * 60, 60,   False, True),
    (SCHEDULE_TYPE_CRON, True,     1, 1.0,                   None, 2 * 24 * 60, 60,   False, True),
    (SCHEDULE_TYPE_CRON, False,    1, 1.0, Event.Severity.WARNING, 2 * 24 * 60, 60,   False, True),
    (SCHEDULE_TYPE_CRON, True,     1, 1.0,   Event.Severity.ERROR,          10, 60,   False, True),
    (SCHEDULE_TYPE_CRON, True,     1, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, None, True,  False),
    (SCHEDULE_TYPE_RATE, True,     1, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, 10,   False, True),
    (SCHEDULE_TYPE_RATE, True,     1, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, 42,   True,  False),
    (SCHEDULE_TYPE_RATE, True,  None, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, 42,   True,  False),
    (SCHEDULE_TYPE_RATE, True,     1, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, None, True,  False),
    (SCHEDULE_TYPE_RATE, False,    1, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, 42,   False, False),
    (SCHEDULE_TYPE_RATE, True,     2, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, 10,   True,  True),
    (SCHEDULE_TYPE_RATE, True,     1, 0.5,   Event.Severity.ERROR, 2 * 24 * 60, 42,   False, True),
    (SCHEDULE_TYPE_RATE, True,     1, 1.0,   Event.Severity.ERROR,          20, 42,   False, True),
    (None,               True,     1, 1.0,   Event.Severity.ERROR, 2 * 24 * 60, None, False, False)
])
@mock_aws
def test_task_schedule_checker_missing_scheduled_executions(
        schedule_type: str, enabled: bool, instance_count: int | None,
        managed_probability: float, event_severity: int,
        schedule_updated_minutes_ago: int,
        last_execution_minutes_ago: int | None, last_execution_counts: bool,
    ...
    num_instance_count = instance_count or 1
    ...
    for _ in range(2):
        ...
        if should_expect_event:
            ...
            expected_missing_count = num_instance_count
