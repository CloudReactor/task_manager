...
""", [
    ...
    (SCHEDULE_TYPE_CRON, True,  None, 1.0,   Event.SEVERITY_ERROR, 2 * 24 * 60, 60,   True,  False),
    ...
    (SCHEDULE_TYPE_RATE, True,  None, 1.0,   Event.SEVERITY_ERROR, 2 * 24 * 60, 42,   True,  False),
